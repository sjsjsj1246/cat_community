...
__webpack_require__.d(__webpack_exports__, {
  "Z": function() { return /* binding */ layouts_AppLayout; }
});
...
const ButtonWrapper = (external_styled_components_default()).div`
  margin-top: 0.8rem;
`;
const ZButton = external_styled_components_default()(external_antd_.Button)`
...
/* harmony default export */ var AccountForm = (LoginForm);
...
const ZLayout = external_styled_components_default()(external_antd_.Layout)`
  min-height: 100vh;
`;
const ZHeader = external_styled_components_default()(Header)`
  padding: 0;
  display: flex;
...
`;
const ZSider = external_styled_components_default()(Sider)`
  text-align: center;
`;
const ZCard = external_styled_components_default()(external_antd_.Card)`
  width: inherit;
`;
const XLoading = (external_styled_components_default()).div`
  color: white;
  font-size: 1.3rem;
  font-weight: 700;
`;
const ZFooter = external_styled_components_default()(Footer)`
  text-align: center;
  @media only screen and (max-width: 768px) {
    font-size: 0.7rem;
  }
...
`;
const AppLayout_ZButton = external_styled_components_default()(external_antd_.Button)`
  background-color: rgb(228, 35, 76);
  border-color: rgb(228, 35, 76);
  color: rgb(0, 22, 40);
  font-weight: 500;
  ...
  bottom: 30px;
`;
const XImageBox = (external_styled_components_default()).div`
  margin-top: 10px;
`;
...
/* harmony default export */ var layouts_AppLayout = (AppLayout);
